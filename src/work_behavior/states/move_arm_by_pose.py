...
class MoveArmState(smach.State):
    def __init__(self):
        smach.State.__init__(self, outcomes=['succeeded', 'failed'], input_keys=['target_pose'])
        # Inicializar o moveit_commander
        moveit_commander.roscpp_initialize(sys.argv)
        self.robot = moveit_commander.RobotCommander()
        self.group = moveit_commander.MoveGroupCommander("arm")  # Certifique-se de que o nome do grupo esteja correto
    ...
    def execute(self, userdata):
        ...
        rospy.loginfo("Movendo o braço para a posição: {}".format(target_pose.pose.position))
